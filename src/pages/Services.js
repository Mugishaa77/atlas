...
<ul>
    ...
    <p>We <span>sell teas </span>
     at the Mombasa Tea Auction under the rules and
      regulations set by the <span>East Africa Tea Trade Association (EATTA). </span><br/> Our team of experts carefully handles
...
<li> <h4>Training</h4>
    <p>We are dedicated to securing the <span>future of the tea industry</span> by offering comprehensive <span>internship programs</span> to
         young workers within our company.
         <br/> Through these programs, participants gain invaluable expertise and hands-on
...
<br/> Our vast network of international buyers and producers allows
us to connect parties directly, enabling smooth trade negotiations.</p>
</li>
<br/><br/><br/>
<li>
    <h4>
...
<a href="" className="note"><em>View Garden Catalogue</em></a></p></li>
  ...
  <div className="service-close">
   ...
   <p >As responsible brokers, we <span>actively advocate</span> for <strong>sustainable </strong>
    and <strong>eco-friendly</strong> practices
within the tea industry. <br/>
We partner with <strong>socially responsible</strong> tea gardens and buyers who
share our values, supporting their efforts to promote <span>sustainability</span> and
 <span> fair-trade practices</span>.</p></div>
</div>
