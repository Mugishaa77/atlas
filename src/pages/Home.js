  ...
  return (
    <div>
      <div className="home" style={homeStyles}>
        <h1 className="glass-text">We Know Tea!</h1>
      </div>

      <div className="home-about">
        <h1>
          ATLAS TEA BROKERS LIMITED
          <hr />
        </h1>

        <div className="about-p">
          <p>
            Atlas is a Tea Company that was established in 2002.
            <br />
            We have been members of the{" "}
            <strong>East African Tea Trade Association</strong> since July 2015.
          </p>
        </div>
      ...
      <div className="mid-part">
        ...
        <div className="home-gardens">
          <h3>
            <Link to="/garden" title="See Tea Gardens">
              Tea Estates
        ...
        <div className="home-auction">
          <h3>
            <Link to="/auction" title="See Auction Page">
              Tea Auction <FontAwesomeIcon icon={faGavel} />
            </Link>
          </h3>
        </div>
      </div>
      ...
      <div className="footer">
        <div className="footer-inner">
          ...
          <h3>
            <a
              href="https://maps.app.goo.gl/Epx7EccvX8pgA8ba7"
              target="_blank"
              rel="noopener noreferrer"
              title="go to pin"
            >
              Shree Plaza Building, 4th Floor{" "}
              <sup className="redirect">
                <svg
